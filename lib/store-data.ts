...
export const fallbackProducts: Product[] = [
  { id: "p1", slug: "verdant-runner", name: "Verdant Runner", brand: "Reebok", category: "Runners", gender: "Unisex", size: "EU 42", condition: "Excellent", conditionNotes: "Light creasing on toe box. Sole and lining are freshly deep-cleaned.", price: 12400, compareAtPrice: 15900, imageUrl: "/images/runner-green.png", imageAlt: "Green and cream retro running shoes", color: "Green", isFeatured: true, stock: 1 },
  ...
  { id: "p4", slug: "crimson-mile", name: "Crimson Mile", brand: "New Balance", category: "Runners", gender: "Women", size: "EU 39", condition: "Very Good", conditionNotes: "Soft upper with small cosmetic mark near outer panel.", price: 11600, compareAtPrice: 14800, imageUrl: "/images/runner-red.png", imageAlt: "Red and cream vintage running shoes", color: "Red", isFeatured: true, stock: 1 },
]
