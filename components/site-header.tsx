...
export function SiteHeader({ user, isAdmin }: { user: AccountMenuUser | null; isAdmin: boolean }) {
  ...
  return <>
    <div className="whitespace-nowrap bg-primary px-2 py-2 text-center text-[10px] font-semibold uppercase tracking-wide text-primary-foreground md:px-4 md:text-xs md:tracking-widest">Professionally cleaned · Nationwide delivery · One pair only</div>
